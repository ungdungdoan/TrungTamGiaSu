...
public class QuanLyGiaSu extends JFrame {
	...
	public QuanLyGiaSu() {
		...
		JLabel lblNewLabel = new JLabel("Quản lý thông tin gia sư");
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setForeground(Color.RED);
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 30));
		lblNewLabel.setBounds(269, 11, 408, 53);
		...
		btnSearch.setBounds(550, 314, 169, 33);
		...
		btnDelete.setBounds(729, 195, 181, 38);
		...
		btnEdit.setBounds(729, 133, 181, 38);
